...
ap.add_argument("--min_score", default= 0.2, type= float, help = "Min score for NMS")
ap.add_argument("--max_overlap", default= 0.45, type= float, help = "Max overlap for NMS")
ap.add_argument("--top_k", default= 10, type= int, help = "Top k for NMS")
args = ap.parse_args()
...
def detect(original_image, min_score, max_overlap, top_k, suppress = None):
    ...
    font = ImageFont.truetype('./Font/Times_New_Roman.ttf', 15)
